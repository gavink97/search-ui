...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2223)), "/Users/gavinkondrath/Desktop/DevOps/web_app/next/app/page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 729)), "/Users/gavinkondrath/Desktop/DevOps/web_app/next/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/gavinkondrath/Desktop/DevOps/web_app/next/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9914))
...
;// CONCATENATED MODULE: ./components/result-card.tsx



function ResultCard({ name, price, location, post, image, timestamp }) {
...
// EXTERNAL MODULE: ./node_modules/@radix-ui/react-label/dist/index.mjs + 4 modules
var dist = __webpack_require__(3439);
...
;// CONCATENATED MODULE: ./components/search-results.tsx
/* __next_internal_client_entry_do_not_use__ SearchResult auto */ 
...
function SearchResult({ resultList }) {
    ...
    const searchFilter = (resultList, searchText)=>{
        const formattedSearchText = searchText.toLowerCase().replace(/\s/g, "_");
        return resultList.filter((result)=>result.title.toLowerCase().includes(searchText.toLowerCase()) || result.source.toLowerCase().replace(/\s/g, "_").includes(formattedSearchText) || result.location.toLowerCase().includes(searchText.toLowerCase()));
    };
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "grid w-full max-w-sm mb-6 mt-2 items-center gap-1.5",
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx(Label, {
                            htmlFor: "searchResultId"
                        }),
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: filteredResults.map((result)=>{
                    return /*#__PURE__*/ jsx_runtime_.jsx(ResultCard, {
                        name: result.title,
                        price: result.price,
...
/* harmony import */ var next_font_google_target_css_path_app_layout_tsx_import_Inter_arguments_subsets_latin_variableName_inter___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9298);
            ...
            children: [
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("header", {
                    ...
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        className: "z-10 w-full max-w-5xl items-center text-sm lg:flex",
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_1___default()), {
                            href: "/",
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                                className: "text-2xl text-bold",
                                children: "Record Player Search Tool"
                            })
                        })
                    })
                }),
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/gavinkondrath/Desktop/DevOps/web_app/next/components/search-results.tsx`)
...
const e0 = proxy["SearchResult"];

;// CONCATENATED MODULE: ./lib/searchAPI.ts
...
var __webpack_exports__ = __webpack_require__.X(0, [381,168], () => (__webpack_exec__(4874)));
